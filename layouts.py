                    ...
                    children=[
                        dcc.Tabs(id='main-page-tabs', value='layer3',
                                 children=[
                                     ...
                                     dcc.Tab(selected_style=main_page_graph_tab_selected,className='main-page-graph-tab', id={'type': 'main_tabs','index': 4}, label='ACL Refactor', value='all_things_acl'),
                                 ]),
